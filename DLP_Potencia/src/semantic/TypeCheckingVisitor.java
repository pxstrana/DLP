...
public class TypeCheckingVisitor extends AbstractVisitor<Void, Type> {
	...
	@Override
	public Void visit(PowerExpression powerExpression, Type params) {
		super.visit(powerExpression, params);
		if(powerExpression.getBase().getType().isInteger() && powerExpression.getExponent().getType().isInteger())
			powerExpression.setType(powerExpression.getBase().getType());
		return null;
	}
