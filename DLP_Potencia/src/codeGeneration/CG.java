...
public class CG {
	...
	public CG(String filename) {//cambiar
		this.filename=filename;
		 try {
	            this.printer = new PrintStream(new FileOutputStream("outputDLP.txt"));
	...
	public void label(int labelNumber2) {
		printer.println("label"+labelNumber2+":");
	}
	public void functionlabel(String id) {
		printer.println(id+":");
	}
	
	public void jmp(int labelNumber2) {
		printer.println("	jmp label"+labelNumber2);
	}
	public void jz(int i) {
		printer.println("	jz label"+i);
	}
	...
	public void enter(int numOfBytes) {
		printer.println("	enter	"+numOfBytes+2);
	}
	public void ret(int size,int sizeLocalVariables,int sizeLocalArguments) {
		printer.println("	ret "+size+", "+sizeLocalVariables+2+", "+sizeLocalArguments);
	}
	public void halt() {
